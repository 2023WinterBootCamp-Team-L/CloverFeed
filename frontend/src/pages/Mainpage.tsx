...
function Mainpage() {
  ...
  return (
    <div
      className="bg-gradient-to-t from-c-gray flex flex-col mx-auto h-full gap-10 px-5 py-8"
      style={{ width: "393px" }}
    >
      <div>
        ...
        <p className="text-[16px] font-pre font-bold">강지은님의 네잎클로버</p>
      </div>
      ...
      <div className="flex justify-center">
        <div className="flex flex-col justify-start gap-4">
          <p className="font-pre text-[16px] font-bold">Feedback</p>
